...
int[][] conRate2 = new int[16*16][16*16];
int[][] conRate3 = new int[16][16];

int[] sort_conRate2 = new int[16*16];
//int[] sort_conRate2_num = new int[16*16];
int conRates = 0;
int conRates3 = 0;
